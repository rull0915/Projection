...
bool CheckHitWithRay(const Ray& ray, float distance, BaseCollider* col, RaycastHit& hit)
{
    ...
    case ColliderType::Sphere:
        return CheckHitWithRay(ray, distance, static_cast<SphereCollider*>(col), hit);
    case ColliderType::Capsule:
        return CheckHitWithRay(ray, distance, static_cast<CapsuleCollider*>(col), hit);
    case ColliderType::Box:
        return CheckHitWithRay(ray, distance, static_cast<BoxCollider*>(col), hit);
    default:
        break;
    }
...
bool CheckHitWithRay(const Ray& ray, float maxDistance, SphereCollider* col, RaycastHit& hit)
{
    // 球と線の連立方程式を解く方法を使用
