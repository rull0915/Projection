...
#include "GameLib/GameObject/Managers/3DManagers/Ray/Ray.h"
...
class BaseCamera : public BaseComponent
{
    ...
    // ----------------------------------------------------
public:
    static constexpr ComponentID TYPE_ID = ComponentID::Camera;
...
public:
    ...
    // コンストラクタ / デストラクタ
    //-----------------------------------------------------
    BaseCamera(IComponentOwner* own, ComponentID type, bool isMain)
    	: BaseComponent(own, type, isMain)
        , m_view{}
        , m_proj{}
        , m_inverseView{}
        , m_inverseProj{}
